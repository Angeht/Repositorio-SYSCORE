<div class="min-h-screen bg-[#030712] text-slate-100">
    ...
    <main class="px-5 pb-24 pt-36">
        <section class="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
                <p class="mb-4 text-xs font-bold uppercase tracking-[0.35em] text-cyan-300">Nosotros</p>
                <h1 class="max-w-4xl text-5xl font-black tracking-tight text-white md:text-7xl">
                    Construimos software claro para problemas reales.
                </h1>
                <p class="mt-8 max-w-3xl text-lg leading-8 text-slate-400">
                    SysCore es un equipo de desarrollo enfocado en crear soluciones web estables,
                    organizadas y faciles de mantener para empresas, emprendimientos y procesos internos.
                </p>
            </div>
            ...
            <div class="rounded-md border border-cyan-400/10 bg-[#07101f] p-8">
                ...
                <div class="mt-8 space-y-5">
                    @foreach (['Analisis', 'Diseno', 'Desarrollo', 'Pruebas', 'Soporte'] as $step)
